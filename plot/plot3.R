...
ggsave("../../output/plot/simulation_svtype_Precision.pdf", width = 20, height = 20, units = "cm")
...
ggsave("../../output/plot/simulation_svtype_Recall.pdf", width = 216, height = 279, units = "mm")
