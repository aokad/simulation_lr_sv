...
python3 $PWD/simulation_sv_set/script/count_TP_FP_FN_svtype.py $PWD/output/vs_golden_data/delly $PWD/output/vs_golden_data/delly/simulation_count_svtype.txt
