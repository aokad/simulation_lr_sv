...
mkdir -p $WDIR/output/savana/${NAME}/
singularity exec $PWD/image/savana_0.2.3.sif \
  savana \
    --tumour $WDIR/output/subsample/minimap2/simulated_chr1-22XY.${NAME}.merge.subsample.bam \
    --normal $WDIR/output/subsample/minimap2_germline2/simulated_chr1-22XY.${CONTROL}.merge.subsample.bam \
    --outdir $WDIR/output/savana/${NAME}/ \
    --ref    /home/aiokada/resources/database/GRCh38.d1.vd1/GRCh38.d1.vd1.fa \
    --threads 8
